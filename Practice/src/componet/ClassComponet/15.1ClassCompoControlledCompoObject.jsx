                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <form action="">
                                <MDBInput type='text' size='lg' label='Firstname' value={(this.state.formdata.firstname) ? this.state.formdata.firstname : ""} name="firstname" id="firstname" onChange={this.inputData} className='d-block' />
